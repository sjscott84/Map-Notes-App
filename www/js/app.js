...
app.controller('MenuCtrl', ['$scope', '$ionicSideMenuDelegate', '$state', 'popup', 'server', 'listView', 'fitBounds', 'existingPlaces', function($scope, $ionicSideMenuDelegate, $state, popup, server, listView, fitBounds, existingPlaces){
  $scope.tasks = [
